export class GameConfig {
  ...
  constructor() {
    this._isMobile = this.isClientOnMobile();

    this.rightClickChange = this.isRightClickChange();
  }
