<template>
  <div @contextmenu="rightClick($event)" class="picross-container">
    ...
    <div :class="gameWin ? 'picross-win' : ''" @touchmove.prevent class="relative picross select-none" ref="picross">

      <div class="win-message" v-if="gameWin">
        GG tu as gagné !
      </div>
    ...
    <div class="flex justify-around items-center w-full" v-if="!gameWin">
